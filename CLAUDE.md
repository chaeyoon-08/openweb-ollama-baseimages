...
- **커밋 메시지 형식:** Conventional Commits 형식을 따를 것. 타입 prefix는 영문(`feat`, `fix`, `docs`, `chore`, `refactor`), 설명은 한국어로 작성. 예: `docs(readme): README 전면 개편`, `fix(openwebui): DB 디렉토리 사전 생성으로 기동 오류 수정`
